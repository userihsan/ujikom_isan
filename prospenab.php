                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                              <?php 
                                            $cari = $_POST['cari'];
                                            $sql = "SELECT * FROM tb_absen_pulang  WHERE id_karyawan LIKE '%$cari%' OR nama LIKE '%$cari%'";
                                            $query = mysqli_query($koneksi, $sql);
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
